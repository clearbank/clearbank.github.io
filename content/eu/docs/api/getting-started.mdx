...
2. For messages without a body, this value is generated from your `HTTP METHOD`, `Query Path`, `X-Request-Id`, and `X-Request-Time` values. For messages with a body, hash the encoded value using SHA-256 and use the value
