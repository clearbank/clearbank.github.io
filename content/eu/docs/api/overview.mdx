...
The ClearBank European API is a JSON RESTful API which allows you to interact with our Accounts and Clearing products. [Webhooks](./getting-started#use-webhooks) are used to deliver asynchronous event notifications such as transaction confirmations and account-specific reconciliations as they occur.
