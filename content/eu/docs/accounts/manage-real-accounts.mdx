...
**Before creating an account, ensure that you know which [account type](./account-types) you need to create.** If you are unsure, contact us.
...
GBP payments to and from a European account are not allowed and would be rejected and returned automatically. For more information about currencies supported by ClearBank accounts, speak to your Client Director.
