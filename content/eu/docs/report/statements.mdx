...
![Image showing when the time zone changes from CET to CEST and the effect the time zone change has on the 24-hour clock.](/assets/images/diagrams/eu/camt053-time-zone-eu-graphic.svg "time zones for camt.053 statement requests")
...
![Image showing camt.053 statement message flow](/assets/images/diagrams/shared/camt053-message-flow.svg "camt.053 statement request message flow")
