...
This table lists all the webhooks in the ClearBank API for Europe, with links to further information.
...
| [CustomerAccounts.TransactionCompleted (SCT)](../eur-payments/sepa-credit-transfer#customer-accounts-transaction-completed-webhook)|1|Notification that an SCT transaction has completed |
| [CustomerAccounts.TransactionCompleted (SCT Inst)](../eur-payments/sepa-instant-credit-transfer#customer-accounts-transaction-completed-webhook)|1|Notification that an SCT Inst transaction has completed |
| [CustomerAccounts.TransactionCompleted (T2)](../eur-payments/t2#customer-accounts-transaction-completed-webhook)|1|Notification that a T2 transaction has completed |
...
| [Sepa.Instant.Outbound.Payment.Delayed](../eur-payments/sepa-instant-credit-transfer#sepa-instant-outbound-payment-delayed-webhook)|1|Notification that an outbound SCT Inst payment has been delayed |
