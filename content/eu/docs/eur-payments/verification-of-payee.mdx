...
<br />
<br />
Clients may choose to use our VOP Requesting service to initiate VoP checks, or alternatively, integrate with a provider of their choice. Clients must use ClearBank's VoP Responding service, when using a ClearBank BIC, however this requires no integration on your side. If your PSP is based outside of the Eurozone, then you will not automatically become VoP reachable as the VoP regime will only be applicable to those PSPs from 2027.
<br />
<br />
<b>Note:</b> To use the VoP endpoint in the production environment, you must complete a test pack and self-certify your testing. For more details, reach out to our EU API team.
</Callout>
