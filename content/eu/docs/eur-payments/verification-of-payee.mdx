...
[Verification of Payee (VoP)](/eu/docs/api/glossary#verification-of-payee) is a name and [IBAN]() verification service that checks whether the payee name provided by the payer matches the account holder name at the receiving payment service provider (PSP). 
