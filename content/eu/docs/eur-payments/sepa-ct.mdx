...
SEPA CT (Single Euro Payments Area Credit Transfer) is a payment scheme that enables you to move euro between scheme participants. Transactions are capped at €999,999,999 per payment.
...
If your recall request has been accepted, you will be notified via the [Customer Accounts Transaction Completed](#customer-accounts-transaction-completed-webhook) and the [SEPA CT Outbound Payment Return Completed](#sepa-ct-outbound-payment-return-completed-webhook) webhooks.
...
Once the return has been processed, you will either receive the [Customer Accounts Transaction Completed](#customer-accounts-transaction-completed-webhook) and [SEPA CT Inbound Payment Return Completed](#sepa-ct-inbound-payment-return-completed-webhook) webhooks or the [SEPA CT Inbound Payment Return Failed](#sepa-ct-inbound-payment-return-failed-webhook) webhook.
