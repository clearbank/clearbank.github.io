...
If your recall request has been rejected, you will be notified via the [SEPA CT Payment Recall Rejected](#sepa-ct-outbound-payment-recall-rejected-webhook) webhook.
