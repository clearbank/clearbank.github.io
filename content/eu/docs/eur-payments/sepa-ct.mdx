...
You will be notified of a successful SEPA CT return via the [SEPA CT Outbound Payment Return Completed webhook
](#sepa-ct-outbound-payment-return-completed-webhook) webhooks.
