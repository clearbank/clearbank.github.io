...
You may receive a recall request via the [Recall Request webhook](#sepa-ct-inbound-payment-recalled-webhook). To respond to the recall request, use the [/v1/payments/sepa/{paymentId}/recall-response](#respond-to-an-sct-recall-request) endpoint.
