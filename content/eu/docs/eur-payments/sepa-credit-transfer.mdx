...
![A message flow diagram explaining how to send an SCT payment](/assets/images/diagrams/eu/sepa-ct-send-payment.svg)
...
![A message flow diagram explaining how to an SCT recall request is sent, then accepted or rejected by the original creditor](/assets/images/diagrams/eu/sepa-ct-recall-request.svg)
...
![A message flow diagram showing how to accept an inbound SCT recall request](/assets/images/diagrams/eu/sepa-ct-recall-response-accepted.svg)
...
![A message flow diagram showing how to reject an inbound SCT recall request](/assets/images/diagrams/eu/sepa-ct-recall-response-rejected.svg)
...
![A message flow diagram explaining how to send an SCT return](/assets/images/diagrams/eu/sepa-ct-return.svg)
