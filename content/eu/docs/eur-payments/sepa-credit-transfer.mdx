  ...
  endpoints={[
    {
      ...
      version: "1.0-SEPA-CT",
      exGateway: true,
      scopeRefs: ["payments:sepa-ct:create"],
      webhooks: [
  ...
  endpoints={[
    {
      ...
      version: "1.0-SEPA-CT",
      exGateway: true,
      scopeRefs: ["payments:sepa-ct:return"],
      webhooks: [
...
<Callout colour="blue">
<p>If <b>RecallResponseAccepted</b> is set to <b>true</b>, a pacs.004 payment will be automatically initiated. You do not need to initiate a payment.</p>
</Callout>
