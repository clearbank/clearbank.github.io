...
SCT outbound payments can fail for several reasons. Refer to the below list of possible failure codes and their definitions for more detail:

| Reason code | Description                                                           |
| ----------- | --------------------------------------------------------------------- |
| AB15        | Account is held suspense account / account is repair suspense account |
| AC01        | Account identifier invalid or incorrect                               |
| AC04        | Account not active / closed                                           |
| AC06        | Blocked account                                                       |
| AM03        | EUR currency not enabled                                              |
| AM04        | Insufficient funds                                                    |
| BE01        | Account does not belong to institution                                |
| CB01        | Unknown error                                                         |
| CB02        | A valid creditor agent BIC cannot be derived from the supplied IBAN   |
...
When you call our endpoints in simulation, any IBANs you provide are checked for validity. The below table lists valid and invalid IBANs you can use to support your testing:
