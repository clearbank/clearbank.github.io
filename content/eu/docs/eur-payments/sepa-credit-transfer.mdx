...
![A message flow diagram showing how to accept an inbound SCT recall request](/assets/images/sepa-ct-recall-response-accepted.svg)
...
![A message flow diagram showing how to reject an inbound SCT recall request](/assets/images/sepa-ct-recall-response-rejected.svg)
