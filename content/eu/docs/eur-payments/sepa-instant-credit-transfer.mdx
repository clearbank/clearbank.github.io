...
<Callout colour="blue">
<p>SEPA ICT is currently an optional scheme. New regulation means that by January 2025 all Eurozone participants utilising the euro currency that offer SEPA CT (SEPA Credit Transfer) must also offer SEPA Instant CT.</p>
...
> You are notified of incoming SEPA Instant CT payments via the [SEPA Instant CT Inbound Payment Settled webhook](#sepa-instant-ct-inbound-payment-settled-webhook) and the [Customer Accounts Transaction Completed webhook](#customer-accounts-transaction-completed-webhook).
...
## Sending a SEPA Instant CT payment

To submit a payment, use the [POST /v1/payments/sepa-instant](#send-a-sepa-instant-payment) endpoint.

You will receive the [SEPA Instant CT Payment Created webhook](#sepa-instant-ct-outbound-payment-created-webhook). Once the payment has settled, you will receive the [SEPA Instant CT Outbound Payment Settled webhook](#sepa-instant-ct-outbound-payment-settled-webhook) and the [Customer Accounts Transaction Completed webhook](#customer-accounts-transaction-completed-webhook).
  ...
  endpoints={[
    {
      ...
      webhooks: [
        'sepa-instant-ct-outbound-payment-created-v1',
        'sepa-instant-ct-outbound-payment-settled-v1',
        'sepa-instant-ct-outbound-payment-cancelled-v1',
...
<WebhookPlaceholder render='sepa-instant-ct-outbound-payment-created-v1' />
<WebhookPlaceholder render='sepa-instant-ct-outbound-payment-settled-v1'/>
<WebhookPlaceholder render='sepa-instant-ct-outbound-payment-cancelled-v1' />
...
<WebhookPlaceholder render='sepa-instant-ct-inbound-payment-settled-v1' />
  ...
  endpoints={[
    {
      ...
      version: "1.0-SEPA-INSTANT",
      webhooks: [
        'sepa-instant-ct-recall-payment-created-v2',
        'sepa-instant-ct-recall-payment-settled-v2',
        'sepa-instant-ct-recall-payment-cancelled-v2',
        'eu-customer-accounts-transaction-completed-v1'
      ]
    }
  ]}
...
<WebhookPlaceholder render='sepa-instant-ct-recall-payment-settled-v2' />
<WebhookPlaceholder render='sepa-instant-ct-recall-request-rejected-v2' />
...
<WebhookPlaceholder render='sepa-instant-ct-recall-request-received-v2' />
  ...
  endpoints={[
    {
      ...
      version: "1.0-SEPA-INSTANT",
      webhooks:[
        'sepa-instant-ct-recall-request-received-v2',
        'sepa-instant-ct-recall-payment-created-v2',
        'sepa-instant-ct-recall-payment-settled-v2'
      ]
    }
...
<WebhookPlaceholder render='sepa-instant-ct-recall-payment-created-v2' />
<WebhookPlaceholder render='sepa-instant-ct-recall-payment-settled-v2' />
...
<WebhookPlaceholder render='sepa-instant-ct-recall-payment-cancelled-v2' />
