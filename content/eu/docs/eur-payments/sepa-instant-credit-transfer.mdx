...
![A message flow diagram explaining how to send an SCT Inst payment](/assets/images/diagrams/eu/sct-inst-send-payment.svg)
...
![A message flow diagram explaining a successful SCT Inst recall which results in receiving a SEPA Instant Recall Payment Settled webhook](/assets/images/diagrams/eu/sct-inst-successful-recall.svg)

![A message flow diagram explaining a rejected SCT Inst recall which results in receiving a SEPA Instant Recall Request Rejected webhook](/assets/images/diagrams/eu/sct-inst-rejected-recall.svg)
...
![A message flow diagram explaining responding to a recall request with 'approve' followed by the pacs.004 payment being rejected at RT1 resulting in receiving a SEPA Instant Recall Payment Cancelled webhook](/assets/images/diagrams/eu/sct-inst-recall-payment-cancelled.svg)
