...
<Callout colour="blue">
  When a payment is delayed and the settles, the TransactionId will be changed. You can instead use the PaymentId as an identifier that remains unchanged throughout the payment's lifecycle.
</Callout>
