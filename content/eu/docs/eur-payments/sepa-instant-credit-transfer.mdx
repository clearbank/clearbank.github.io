...
## Simulate SEPA Instant CT payment scenarios

The following will allow you to test SEPA Instant CT payment scenarios in the ClearBank simulation environment.

<EndpointBlock
  type="post"
  title="Simulate an inbound SEPA Instant CT payment"
  endpoints={[
    {
...
<EndpointBlock
  type="post"
  title="Simulate an inbound SEPA Instant CT recall request"
  endpoints={[
    {
