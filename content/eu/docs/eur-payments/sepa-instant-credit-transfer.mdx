...
- [Simulate an SCT Inst inbound payment and recall request](#simulate-an-sct-inst-inbound-payment-and-recall-request)
...
## Simulate an SCT Inst inbound payment and recall request
