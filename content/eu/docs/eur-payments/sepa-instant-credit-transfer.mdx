...
## SEPA Indirect
SEPA Indirect allows you to participate in SEPA under **your own BIC and IBANs**, while connecting to ClearBank through the same APIs you already use. ClearBank Europe (ClearBank NL) acts as your sponsoring direct participant, providing scheme access, clearing, and settlement on your behalf.
...
- **Minimal change to existing flows** – integrate with our API and continue operating as you do today.
