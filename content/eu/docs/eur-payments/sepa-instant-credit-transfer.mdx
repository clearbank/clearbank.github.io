...
## Simulate SEPA Instant inbound payment and recall

<EndpointBlock
  type="post"
  title="Simulate an inbound SEPA ICT payment in the simulation environment"
  endpoints={[
    {
...
<EndpointBlock
  type="post"
  title="Simulate an inbound SEPA ICT recall request in the simulation environment"
  endpoints={[
    {
...
![A message flow diagram explaining a successful SEPA ICT recall](/assets/images/sepa-ict-successful-recall.svg)

![A message flow diagram explaining a rejected SEPA ICT recall](/assets/images/sepa-ict-rejected-recall.svg)
  ...
  endpoints={[
    {
      ...
      webhooks:[
        ...
        'sepa-instant-recall-request-rejected-v2'
      ]
    }
  ]}
/>