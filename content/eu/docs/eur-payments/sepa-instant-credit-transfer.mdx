...
<Callout colour="blue">
  If you receive cancellation reason code <strong>MS03</strong>, you should attempt to resend the affected payment via SEPA Credit Transfer instead of SCT Inst.
</Callout>
