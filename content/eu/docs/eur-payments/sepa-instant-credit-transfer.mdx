...
SEPA Instant Credit Transfer (SCT Inst) is a payment scheme that enables customers to make and receive payments quickly. It allows payments up to a maximum value of €100,000, and settles these within 10 seconds. Payments can be sent at any time, including bank holidays and weekends.
