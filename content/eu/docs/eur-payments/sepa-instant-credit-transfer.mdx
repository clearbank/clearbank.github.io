...
![A message flow diagram explaining receiving a recall request, being notified via the SEPA Instant CT Recall Request Received webhook and responding using the POST /v1/payments/sepa-instant/{paymentId}/recall-response endpoint](/assets/images/sepa-ict-receive-recall.svg)
