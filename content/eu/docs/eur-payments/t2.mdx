...
For institution payments (pacs.009), the T2 scheme does not require IBANs to be provided. We direct any inbound institution payments that do **not** include an IBAN to your [**Primary Operating Account**](../accounts/account-types) (this is the first Operating Account created).
