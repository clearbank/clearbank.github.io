...
![T2 message flow diagram](/assets/images/diagrams/eu/Target2-message-flow.svg)
...
![T2 send a payment message flow diagram](/assets/images/diagrams/eu/t2-send-payment.svg)
...
![T2 return a payment message flow diagram](/assets/images/diagrams/eu/t2-return-payment.svg)
...
![T2 send an FI payment message flow diagram](/assets/images/diagrams/eu/t2-send-FI-payment.svg)
