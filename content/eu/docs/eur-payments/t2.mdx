...
* We require you to provide an IBAN for [outbound institution payments](#sending-a-t2-payment-to-an-institution). However, the T2 scheme does not require it. We direct any inbound institution payments that do **not** include an IBAN to your [**Primary Operating Account**](../accounts/account-types.mdx) (this is the first Operating Account created).
