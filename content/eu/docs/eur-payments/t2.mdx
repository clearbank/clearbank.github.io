  ...
  endpoints={[
    {
      ...
      version: "1.0-T2",
      exGateway: true,
      scopeRefs: ["payments:t2-rtgs:create"],
      webhooks: [
...
The following error codes may appear in the `Errors` field of the T2 failure webhooks listed below, helping you understand why a T2 payment was unsuccessful:
...
| CNOR       | Creditor Bank not registered/routable via T2 |
  ...
  endpoints={[
    {
      ...
      version: "1.0-T2",
      exGateway: true,
      scopeRefs: ["payments:t2-rtgs:return"],
      webhooks: [
