...
A refund is a post settlement R-flow where funds from a SEPA Direct Debit are returned to the debtor's account following request from the debtor. This can happen for various reasons, such as a dispute raised by the debtor or a withdrawal of consent.
