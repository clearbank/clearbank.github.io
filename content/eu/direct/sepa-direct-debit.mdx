...
![A message flow diagram showing which responses and webhooks you will receive after requesting to simulate an inbound direct debit.](/assets/images/diagrams/eu/sepa-dd/sepa-dd-flow.svg)
