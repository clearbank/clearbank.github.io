...
Please refer to [Webhooks](/webhooks/) for more information.
...
ClearBank® accounts support inbound and outbound CHAPS payments. Being that CHAPS is the UK’s high value payment system, there is no amount limit associated with inbound or outbound CHAPS payments.
However, you can only send or receive CHAPS payments between 08:00 – 17:00 (UK business days only).
