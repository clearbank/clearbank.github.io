...
A new endpoint is being added to enable you to return a faster payment: [/v3/payments/fps/return](#return-an-fps-payment) Note that this endpoint is only currently in our simulation environment.
