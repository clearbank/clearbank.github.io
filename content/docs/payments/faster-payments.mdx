...
A new endpoint is being added to enable you to return a faster payment: [/v3/payments/fps/return](#return-an-fps-payment). Note that this endpoint is only currently live in our simulation environment and **might change**. This page will be updated again once the endpoint is finalised and moved into production.
