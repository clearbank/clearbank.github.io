...
-	[PUT/ v1/Cop/opt/accounts/{accountId}](#update-account-to-opt-out-from-the-clearbank-cop-service)
-	[PUT/ v1/Cop/opt/accounts/{accountId}/virtual/{VirtualAccountId}](#update-virtual-account-to-opt-out-from-the-clearbank-cop-service)
...
<EndpointBlock
  type="put"
  title="Update account to opt out from the ClearBank CoP service"
...
<EndpointBlock
  type="put"
  title="Update virtual account to opt out from the ClearBank CoP service"
