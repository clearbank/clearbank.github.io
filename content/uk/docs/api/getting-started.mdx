...
<Callout colour="blue">
  ...
  To access the ClearBank API you will use sensitive credentials including API tokens, private keys and digital certificates. These credentials grant direct access to your data and must be protected at all times. You must store, transmit and manage these credentials securely.<br/><br/>
