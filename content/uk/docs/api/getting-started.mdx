...
| Element              | Payload/Header | Type   | Description                                                                                                                                                             |
| -------------------- | -------------- | ------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| `Type`               | Payload        | string | The type of the event                                                                                                                                                   |
| `Version`            | Payload        | int    | The webhook version                                                                                                                                                     |
| `Nonce`              | Payload        | int    | Cryptographically secure number generated by ClearBank for every single webhook. A nonce number is generated randomly and should not be used as a check for duplication |
| `Payload`            | Payload        | object | Object which contains information related to the webhook                                                                                                                |
