...
Version 4 of the GBP Cross-Border endpoint introduces the changes required by the Bank of England's November 2026 release, together with a small number of ClearBank enhancements. If you are migrating from version 3, the key differences are:
