...
- **Creditor > OrganisationIdentifier > BIC**
  - Do **not** populate this field if the Creditor is an **individual** or a **business**.
  - It is **optional** if the Creditor is a **financial institution**.

  - **CreditorAgent > BIC**
  - This field is **always required**.
  - It must contain the 11-character Business Identifier Code (BIC) of the financial institution that holds the Creditor’s account.

- **Creditor identification blocks**
  - Use the **privateIdentifier object** when the Creditor is an individual.
  - Use the **organisationIdentifier object** when the Creditor is a business or financial institution.
  - The organisation block may include a BIC, but only if the Creditor is a financial institution.
