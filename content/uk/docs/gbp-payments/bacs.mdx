...
>Define bacs suspense account

### Direct Debit refunds and indemnity claims

If your customer notifies you they've been debited in error, they may be entitled to a refund under the Direct Debit Guarantee.
...
If your institution believes the error was made by the billing company (also called Service User - the entity that requested the debit) you can contact ClearBank to raise an indemnity claim against the service user. If ClearBank agrees with your analysis, we'll raise a claim to the Bacs Direct Debit scheme on your behalf, which will return the funds to your refund account(?) 14 business days later.

The billing company may challenge your indemnity claim. If so, you'll need to examine the merits of the claim and decide whether to accept or reject their challenge. If you accept (or do nothing) then the challenge will succeed and the claim will be cancelled. It is then for you to decide if the error was yours, or if there was no error (in this case, customer error == no error). You then would have the right to reverse the refund you gave to your customer [how should this be done?].
