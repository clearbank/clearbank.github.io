...
Bacs does not operate on weekends or bank holidays; the aforementioned three-day cycle may cross over into the next working week if a payment is initiated in the lead-up to a weekend or bank holiday, potentially taking five full calendar days on a typical weekend.
...
**Note:** Bacs credit payments can be recalled by the service user (end customer) or their Payment Services Provider (PSP) until 4pm on day 2 of the Bacs cycle. We'll notify you if this happens via the [Bacs Direct Credit Inbound Payment Recalled](#bacs-direct-credit-inbound-payment-recalled-webhook) webhook.
