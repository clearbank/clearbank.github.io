...
- If the cheque is successfully submitted, but there is missing information, you will receive the Cheque Failed Scrutiny Webhook, accompanied by a reason code.
