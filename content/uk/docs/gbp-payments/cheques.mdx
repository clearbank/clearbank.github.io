...
![alt text](/assets/images/diagrams/uk/cheques/cheque_endpoint_async.png "Message flow diagram explaining how to submit cheques via the endpoint. This is explained in the text below.")
