...
![alt text](/assets/images/cheque_endpoint_async.png "Message flow diagram explaining how to submit cheques via the endpoint. This is explained in the text below.")
