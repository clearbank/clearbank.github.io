...
<Callout colour="blue">This page is for new cheques customers. For cheques customers onboarded before 2026, refer to <a href="../../direct/cheque-sync">Cheque synchronous deposit</a>.
</Callout>
