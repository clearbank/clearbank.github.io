...
- If the cheque is over the limits you defined during onboarding, you will be notified via the Cheque Process Completed Webhook, accompanied by a reason code.
- If a cheque cannot be submitted to the ICS scheme, for example, due to low image quality, you will be notified by the Cheque Process Completed Webhook, accompanied by a reason code.
