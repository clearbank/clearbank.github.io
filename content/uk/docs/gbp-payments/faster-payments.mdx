...
![Message flow diagram showing a single or bulk SOP payment sent outside of supported hours and returning a 400 Bad Request response](/assets/images/diagrams/uk/sop-payment.svg "SOP sent outside of supported hours")
