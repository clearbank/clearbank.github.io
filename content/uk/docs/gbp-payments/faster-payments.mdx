...
| **CB_AccountHoldersBankrupt**        | Payment cannot be applied because of Beneficiary sensitivities – e.g. possible bankruptcy  | Do not retry; escalate and seek legal/compliance guidance            | Do not retry      |
...
| **CB_AccountSwitched**               | Account transferred                                                                        | Use account switching data (e.g. CASS redirection) or request updated details. Follow account switching/redirection guidance or obtain updated details  | Do not retry |
