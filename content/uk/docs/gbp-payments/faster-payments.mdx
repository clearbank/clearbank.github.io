...
| **CB_AccountNameAndNumberMismatch**  | The payment has been rejected by the receiving bank because the beneficiary account name does not match the beneficiary account number | Validate account name against account number (e.g. via CoP) before retrying | Review then retry |
