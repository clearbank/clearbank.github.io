...
ClearBank does not offer Bacs origination capabilities. To become a Service User, you must integrate with a Bacs origination bureau.
...
- [Bacs Direct Debit Indemnity Claim Received Event webhook](#bacs-direct-debit-indemnity-claim-received-event-webhook) - Indicates receipt of a Direct Debit indemnity claim.
