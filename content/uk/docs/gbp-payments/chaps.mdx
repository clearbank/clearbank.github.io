...
- Simulate an inbound CHAPS payment (pacs.008) through the [POST /inbound-payment-simulation/chaps/v2/customer-payments](#simulate-an-inbound-chaps-payment) endpoint.
- Simulate a returned CHAPS payment (pacs.004) through the [POST /inbound-payment-simulation/chaps/v2/return-payments](#simulate-a-returned-chaps-payment) endpoint, or return an existing payment more easily using a simplified request through the [POST /v2/inbound-payment-simulation/return-payment-simplified](../gbp-payments/chaps#simulate-a-chaps-return-payment-using-a-simplified-request) endpoint.
- Simulate a CHAPS bank-to-bank payment (pacs.009) through the [POST /inbound-payment-simulation/chaps/v2/institution-payments](#simulate-a-chaps-bank-to-bank-payment) endpoint.
