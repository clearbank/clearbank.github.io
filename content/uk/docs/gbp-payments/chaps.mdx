...
- Simulate a returned CHAPS payment (pacs.004) through the [POST /inbound-payment-simulation/chaps/v2/return-payments](#simulate-a-return-chaps-payment) endpoint.
