...
To help make sense of the various codes, they have been broken down into eight categories in the following table. The nine categories have been created by ClearBank to support our clients in finding the appropriate codes for their use case when making GBP Cross-Border payments.
