...
ClearBank accounts support inbound and outbound [CHAPS](/uk/docs/api/glossary#chaps) payments. As CHAPS is the UK’s high value payment scheme, there is no amount limit associated with inbound or outbound CHAPS payments.
