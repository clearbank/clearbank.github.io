...
<Callout colour="blue">
For BoE funding clients: the new v6 and current v5 endpoints, as well as all Institution Portal screens, remain available until <strong>17:55</strong>. We recommend that clients who complete Bank of England account funding through the ClearBank Portal screens integrate with the pacs.009 v6 endpoint to offer an alternative means of submitting these payments.
</Callout>
