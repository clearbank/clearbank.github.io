...
- Simulate a returned CHAPS payment (pacs.004) through the [POST /inbound-payment-simulation/chaps/v3/return-payments](#simulate-a-returned-chaps-payment) endpoint, or return an existing payment more easily using a simplified request through the [POST /v2/inbound-payment-simulation/return-payment-simplified](../gbp-payments/chaps#simulate-a-chaps-return-payment-using-a-simplified-request) endpoint.
