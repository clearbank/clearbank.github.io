...
To support upcoming Bank of England changes effective 24 November 2025, we recommend using version 2 of the simulator endpoints for inbound CHAPS payments. Version 2 introduces support for both structured and hybrid address formats. From this date, unstructured address fields will no longer be accepted.
...
Version 1 of the simulator endpoints will be deprecated after November 2025. Please update your test integration to ensure continued compatibility.
