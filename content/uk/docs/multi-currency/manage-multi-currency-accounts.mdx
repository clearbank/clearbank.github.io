  ...
  endpoints={[
    {
      ...
      version: "1.0.MCCY-ACC",
      exGateway: true,
      scopeRefs: ["accounts:currencies:create"],
    }
  ]}
/>
  ...
  endpoints={[
    {
      ...
      version: "1.0.MCCY-ACC",
      exGateway: true,
      scopeRefs: ["accounts:virtual:create"],
      webhooks: [
  ...
  endpoints={[
    {
      ...
      version: "1.0.MCCY-ACC",
      exGateway: true,
      scopeRefs: ["accounts:virtual:read"],
    }
  ]}
/>
  ...
  endpoints={[
    {
      ...
      exGateway: true,
      scopeMatch: "any",
      scopeRefs: ["accounts:properties:update", "accounts:virtual:update"],
      webhooks: [
  ...
  endpoints={[
    {
      ...
      version: "1.0.MCCY-ACC",
      exGateway: true,
      scopeRefs: ["accounts:virtual:delete"],
      webhooks: [
        'mccy-virtual-account-updated-webhook-v1'
      ]
    }
