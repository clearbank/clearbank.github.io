...
<Callout colour="blue">
  Currency availability is affected by UK bank holidays as well as the holidays observed in each currency's country. For more information about currency availability, please speak to your Client Director.
</Callout>
