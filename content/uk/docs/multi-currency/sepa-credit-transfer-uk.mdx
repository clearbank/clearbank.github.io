...
Our SEPA UK service lets you transact euro payments with any SEPA participant bank via the SEPA Credit Transfer (SCT) scheme. To get started with SEPA UK, you'll need a euro denominated account under a ClearBank UK BIC. This will be set up for you as part of your onboarding process.

> You cannot send or receive euro outside of the SEPA zone with SEPA UK. To transact euro outside of SEPA, please refer to our [multi-currency payments service](./multi-currency-payments.mdx).
