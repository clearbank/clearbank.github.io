...
While same day trades may be unavailable on these dates, TOM/SPOT trades will be available to book. Please be mindful of TOM/SPOT trades booked in the days leading up to these dates.
</Callout>
...
Each FX currency pair has a defined maximum trade size per request. If you request a trade exceeding this limit, you'll receive an error response. The table below outlines the maximum allowable trade size for each currency pair:
...
Maximum trade sizes are under regular review and are subject to change as we work to extend the limits based on demand. For more information about maximum trade sizes, please contact your Client Director.
