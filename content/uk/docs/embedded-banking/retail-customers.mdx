...
Cash ISAs first require a retail customer to be created. You can create and manage retail customers using the below endpoints.  
After you've created a customer, you then create and manage their cash ISA using the endpoints on the [Flexible cash ISAs](/uk/docs/embedded-banking/flexible-cash-isas) page.
