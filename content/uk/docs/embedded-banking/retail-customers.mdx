...
<EndpointBlock
  type="post"
  title="Create a current account"
  endpoints={[
    {
      path: "/v4/Accounts",
...
<WebhookPlaceholder render='account-created-webhook-v1' />
 ...
 <Callout colour="blue">
To close a current account, call the below endpoint and set the <b>Status</b> field to <b>Closed</b>.
...
<EndpointBlock
  type="patch"
  title="Amend or update a current account"
  endpoints={[
    {
