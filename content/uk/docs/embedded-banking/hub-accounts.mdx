...
## Link associated and nominated accounts
...
To set or replace the nominated account for a Hub Account, you can use the [PUT /v1/accounts/{accountId}/nominated-account](#set-a-nominated-account) endpoint, or the [POST /v1/accounts/{accountId}/related-accounts](#add-an-associated-or-nominated-account).
...
* No more than 'X' associated accounts may be linked to a Hub Account - where 'X' depends on your arrangement with ClearBank.
* Hub Account funding to and from an associated account may or may not be allowed - depending on your arrangement with ClearBank.

Associated accounts can be added to a Hub Account using the [POST /v1/accounts/{accountId}/related-accounts](#add-an-associated-or-nominated-account) endpoint.
...
First you create a Hub Account with a maximum of 3 associated accounts:
