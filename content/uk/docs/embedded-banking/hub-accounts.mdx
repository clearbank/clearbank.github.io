...
Hub Accounts are [FSCS](/uk/docs/api/glossary#financial-services-compensation-scheme) held with ClearBank that enable innovative financial products. Use cases for Hub Accounts typically involve making payments to and from a defined set of associated accounts.
