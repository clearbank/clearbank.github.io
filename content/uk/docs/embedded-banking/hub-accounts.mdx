...
A Hub Account can be funded and defunded via a nominated account you assign, or via certain associated accounts.  

**Nominated accounts**  
Nominated accounts do not have to be provided by ClearBank: they can be from another external provider. However, the account holder for both accounts must be the same.
...
**Associated accounts**  
You may link several bank accounts - 'associated accounts' - with a Hub Account. The function of these associated accounts will be specific to your institution, and will serve a defined use case.

The following functionality will vary depending on your use case and agreement with ClearBank:

* The number of associated accounts a Hub Account can have.
* Whether an associated account can pay funds into a Hub Account.
* Whether an associated account can receive funds from a Hub Account.

An example business case is provided below:

> You want to facilitate joint purchases, but the involved parties don't necessarily trust each other. You need to ensure all funds are available on neutral ground before proceeding with the purchase.  
> To do this, you could use a Hub Account and two associated accounts to securely hold funds from two the parties, each paying in from their associated account (configured to be pay-in only, maximum 2 associated accounts). The paid in funds remain securely in the Hub Account - held by you / another trusted third party - until everyone is ready to proceed with the purchase.
