...
Using the interest configuration endpoints, you can update the interest configuration of your existing savings accounts. This functionality is enabled on a per-client basis. If you're interested in using this functionality, speak to your Client Director.
...
![A message flow diagram describing the process of setting the daily interest configuration.](/assets/images/diagrams/uk/savings-accounts/savings-account-daily-interest-config.svg)
...
![A message flow diagram describing the process of setting the monthly interest configuration.](/assets/images/diagrams/uk/savings-accounts/savings-account-monthly-interest-config.svg)
...
![A message flow diagram describing the process of future-dating an interest config along with a interest paid daily rather than monthly.](/assets/images/diagrams/uk/savings-accounts/savings-account-introductory-rate.svg)
...
<Callout colour="blue">
<p>Note: to switch the customer to a different interest configuration, you'll need to call the <a href="#update-interest-configuration">Update interest configuration</a> or <a href="#set-future-dated-interest-configurations">Set future-dated interest configurations</a> endpoint.</p>
</Callout>
...
![A diagram showing the flow of customers subscribed to 3 different interest configurations and how their interest rate changes as they change product](/assets/images/diagrams/uk/savings-accounts/interest-config-example.svg)
...
Using the tier examples, an account with a balance of **£7,500.00** would earn interest in the following way depending on the method applied:
