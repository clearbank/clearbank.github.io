...
You can configure multiple interest tiers when creating an interest configuration with us. Tiers allow you to specify balance ranges, each with its own interest rate, allowing you to offer different levels of interest depending on account balance. There are two methods for applying interest to tiers:
...
- **Segregated:** 
  ...
  - The next £5,000.00 fals into **tier 2** and earns an interest rate of **4.00%**
  - The remaining £1,500.00 falls into **tier 3** and earns an interest rate of **4.75%**
