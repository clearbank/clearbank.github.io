...
In a scenario where interest is paid monthly rather than daily, you will not receive daily Interest Paid webhooks. Instead, interest will be calculated using the new rate on the 
