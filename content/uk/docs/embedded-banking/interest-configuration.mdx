...
![A message flow diagram describing the above process of setting the daily interest configuration.](/assets/images/diagrams/uk/savings-account-daily-interest-config.svg)
...
![A message flow diagram describing the above process of setting the monthly interest configuration.](/assets/images/diagrams/uk/savings-account-monthly-interest-config.svg)
...
![A message flow diagram describing the above process of future-dating an interest config along with a interest paid daily rather than monthly.](/assets/images/diagrams/uk/savings-account-introductory-rate.svg)
...
![A diagram showing the flow of customers subscribed to 3 different interest configurations and how their interest rate changes as they change product.](/assets/images/diagrams/uk/interest-config-example.svg)
