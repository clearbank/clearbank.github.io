...
![A message flow diagram describing the above process of setting the daily interest configuration.](/assets/images/diagrams/uk/savings-accounts/savings-account-daily-interest-config.svg)
...
![A message flow diagram describing the above process of setting the monthly interest configuration.](/assets/images/diagrams/uk/savings-accounts/savings-account-monthly-interest-config.svg)
...
![A message flow diagram describing the above process of future-dating an interest config along with a interest paid daily rather than monthly.](/assets/images/diagrams/uk/savings-accounts/savings-account-introductory-rate.svg)
