...
ISA ineligibility can also be caused by an invalid National Insurance number or date of birth. When a customer becomes eligible again, you can redeclare their eligibility for these with the same [**POST /isas/{accountId}/declaration**](#set-a-new-isa-declaration) endpoint.
