...
![Submit the POST /v1/isas endpoint. Once you receive a 201 response, submit the PUT /v1/accounts/{accountId}/nominated-account to set a nominated account. Once you receive a 200 response, funds can now be added to the cash ISA.](/assets/images/diagrams/uk/cash-isa-open.svg)
...
<img src="/assets/images/diagrams/uk/cash-isa-life-cycle.svg" alt="A decision tree diagram explaining the life cycle of a cash ISA." width="100%"/>
...
![Message flow diagram of the cancellation process, as detailed above.](/assets/images/diagrams/uk/cash-isa-cancel.svg)
...
![Message flow diagram of the transfer in process, as detailed above.](/assets/images/diagrams/uk/cash-isa-transfer-in.svg)
...
![Message flow diagram of the transfer out path, as detailed above.](/assets/images/diagrams/uk/cash-isa-transfer-out.svg)
...
![Message flow diagram of the automated transfer in process, as detailed above.](/assets/images/diagrams/uk/tisa-transfer-in-success-message-flow.svg)
...
![Message flow diagram of the automated transfer out process, as detailed above.](/assets/images/diagrams/uk/tisa-transfer-out-success-message-flow.svg)
