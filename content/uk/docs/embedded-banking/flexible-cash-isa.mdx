...
A cash ISA (Individual Savings Account) is a real savings deposit account held with ClearBank that's subject to certain tax benefits <ExternalLink href="https://www.gov.uk/individual-savings-accounts">defined by the UK government</ExternalLink>. It is eligible for [FSCS protection](/uk/docs/api/glossary#financial-services-compensation-scheme), and can be used to send and/or receive payments once a **nominated account** has been defined.
