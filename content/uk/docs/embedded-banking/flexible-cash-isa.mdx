...
**When customer moves their address out of the UK, they can continue paying into their cash ISA until the end of the tax year.**  
We would be notified of this via the ENDPOINT.  
After their address returns to the UK, a new declaration of ISA eligibility must be provided before they can pay into their ISA again.

**When a customer changes their place of residence out of the UK, they cannot pay into their cash ISA any more.**  
We would be notified of a change of residence via the ENDPOINT.  
After their place of residence returns to the UK, a new declaration of ISA eligibility must be provided before they can pay into their ISA again.

**When a customers DoB or NI number is found to be invalid, no further subscriptions can be made.**  
We receive these details via the ENDPOINT.  
After the details are corrected, a new declaration of ISA eligibility must be provided before they can pay into their ISA again.

You can redeclare eligibility using the [**POST /isas/{accountId}/declaration**](#set-a-new-isa-declaration) endpoint.
