...
As part of your simulation onboarding process, you'll be required to simulate 16 scenarios to prove system capability before moving to our production environment.

Each scenario is listed below. Included with each scenario are example payloads to our dedicated ISA transfer simulation endpoints, and steps to get to them.
...
<EndpointBlock
  type="post"
  title="Simulate an automated outward transfer"
  endpoints={[
    {
