...
- **Resubmit the transfer request** - you can do this by calling the **PUT /v1/isas/{accountId}/automated-transfer-in/{urn}** and providing the URN of the existing transfer. An example payload is shown below:
...
The payload parameters, requirements, and response are the same as **POST /v1/isas/{accountId}/automated-transfer-in**, with the account identification fields renamed as shown above.
