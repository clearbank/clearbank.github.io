...
A cash ISA (Individual Savings Account) is a real savings deposit account held with ClearBank that's subject to certain tax benefits <ExternalLink href="https://www.gov.uk/individual-savings-accounts">defined by the UK government</ExternalLink>. It is eligible for FSCS protection, and can be used to send and/or receive payments once a **nominated account** has been defined.
...
A **nominated account** is the account that you transfer funds from, and any remaining funds and interest will be transferred into upon closure of the cash ISA.
  ...
  endpoints={[
    {
      ...
      exGateway: true,
      scopeMatch: "any",
      scopeRefs: ["accounts:funding:update", "accounts:properties:update"],
    }
  ]}
/>
...
- **Resubmit the transfer request** - you can do this by calling the [**PUT /v1/isas/{accountId}/automated-transfer-in/{urn}**](#resubmit-an-automated-cash-isa-transfer-in) and providing the URN of the existing transfer, or
...
As part of your simulation onboarding process, you'll be required to simulate several scenarios to prove your system's capability before graduating to our production environment.
