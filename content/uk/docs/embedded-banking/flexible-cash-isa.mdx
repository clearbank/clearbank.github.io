...
Customers can be made ineligible for cash ISA subscriptions for the following reasons:
...
If the customer should be eligible to continue subscribing to their ISA in the next tax year, you should submit a new declaration of ISA eligibility.
...
Once the customer's place of residence returns to the UK, you should notify us of this then submit a new declaration of ISA eligibility.
...
Once you have a corrected NI or DoB for the customer, you should notify us of this then submit a new declaration of ISA eligibility.
