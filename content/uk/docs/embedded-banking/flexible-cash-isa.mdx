...
The balance of a cash ISA is held by ClearBank and can only be viewed using our API. Cash ISAs are reconciled for you by ClearBank. 
...
![Message flow diagram of the cancellation process, as detailed above.](/assets/images/diagrams/uk/cash-isa/cash-isa-cancel.svg)
...
![Message flow diagram of the transfer in process, as detailed above.](/assets/images/diagrams/uk/cash-isa/cash-isa-transfer-in.svg)
...
![Message flow diagram of the transfer out path, as detailed above.](/assets/images/diagrams/uk/cash-isa/cash-isa-transfer-out.svg)
...
![Message flow diagram of the automated transfer in process, as detailed above.](/assets/images/diagrams/uk/cash-isa/tisa-transfer-in-success-message-flow.svg)
...
![Message flow diagram of the automated transfer out process, as detailed above.](/assets/images/diagrams/uk/cash-isa/tisa-transfer-out-success-message-flow.svg)
