...
Customers can be made ineligible for cash ISA contributions for the following reasons:
...
* You provided us an invalid Date of Birth (DoB) for the customer
...
Once a customer's address returns to the UK, you should notify us of their new details then submit a new declaration of ISA eligibility. If successful, the customer will be able to pay into their ISA again.
...
Once the customer's place of residence returns to the UK, you should notify us of this then submit a new declaration of ISA eligibility. If successful, the customer will be able to pay into their ISA again.

**When a customer's DoB or NI number is found to be invalid, no further subscriptions can be made.**  
You should send us these details via the [**PATCH /v1/customers/retail/{customerId}**](/uk/docs/embedded-banking/retail-customers#update-an-existing-retail-customers-personal-information) and [**POST /v1/customers/retail/**](/uk/docs/embedded-banking/retail-customers#create-a-retail-customer) endpoints.  
Once you have a corrected NI or DoB for the customer, you should notify us of this then submit a new declaration of ISA eligibility. If successful, the customer will be able to pay into their ISA again.
