...
Once you have obtained a corrected NI or date of birth for the customer using the [**PATCH /v1/customers/retail/{customerId}**](/uk/docs/embedded-banking/retail-customers#update-an-existing-retail-customers-personal-information) endpoint, you should notify us of this then submit a new declaration of ISA eligibility.
