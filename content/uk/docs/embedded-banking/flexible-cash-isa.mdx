...
The account is now open and fully operational. You can return details of a cash ISA using the [GET /v1/isas/{accountId}](#get-cash-isa-details) endpoint, or return details of all real accounts, including cash ISAs, using the 
