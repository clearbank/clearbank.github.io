...
![A message flow diagram demonstrating how retail customer KYC work for a success and declined check, and for a check requiring additional information.](/assets/images/kyc-flow.svg)
