...
You can retrieve information on all savings accounts by using the [GET /v3/accounts](#get-all-accounts-real) endpoint, or retrieve information for a specific account through the [GET /v3/Accounts/{accountId}](#get-information-for-a-savings-account) endpoint.

To get end of day balances for a savings account, use the [camt.053 endpoints](../gbp-accounts/account-reporting#statements).
