...
You can check future, current, and all past interest rates by using the [GET /interest/v1/accounts/{accountId}/configurations](#get-an-accounts-interest-configurations) endpoint.
