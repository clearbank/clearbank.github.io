...
You can update the interest configuration of your existing savings accounts. **This endpoint is currently available for testing in simulation and is not yet active.**
