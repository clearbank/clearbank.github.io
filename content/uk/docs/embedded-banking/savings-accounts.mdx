...
> The `interestConfigurationId` field is used to provide the initial interest configuration ID when creating the savings account. For more information on interest configurations, refer to [Interest configurations](#interest-configurations).
