...
- **Junior savings accounts (ages 16–17)** – held by a retail customer aged 16 or 17 and identified using a dedicated ProductId.
...
To create a single savings account, create a retail customer, then include their customer ID in the `customers` array when calling `POST /v2/savings`.
