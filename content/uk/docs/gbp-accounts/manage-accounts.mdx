...
**Before creating an account, check which [account type](./account-types#account-types) you need**. If you are unsure, contact us for assistance.

The balance of a real account is also held by ClearBank and can be viewed in the Institution portal and the ClearBank API. Real accounts are reconciled for you by ClearBank.
