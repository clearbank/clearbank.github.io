...
![Image showing when the UK time zone changes from GMT to BST and the effect the time zone change has on the 24-hour clock.](/assets/images/diagrams/uk/camt053-time-zone-graphic.svg "time zones for camt.053 statement requests")
