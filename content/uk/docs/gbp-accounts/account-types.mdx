...
To create a virtual account with ClearBank, you must create it under one of your real general (also known as pooled) accounts. You can then use the virtual account's Iban to send and receive payments using funds from the associated real account.  
