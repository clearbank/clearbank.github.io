...
![Diagram showing your initial set of accounts](/assets/images/diagrams/uk/accounts/Accounts-Day1-v2.svg "Initial set of accounts")
...
When a payment addressed to a virtual account settles, you'll receive a [Transaction Settled webhook](../gbp-payments/faster-payments#transaction-settled-webhook) addressed to that virtual account's vIBAN. You can use this information to help reconcile the balance of the virtual account.
...
<Callout colour="blue">
An account is only safeguarded if you have prepared a safeguarding letter that adheres to CASS 15 FCA requirements, as per the process above.
</Callout>
