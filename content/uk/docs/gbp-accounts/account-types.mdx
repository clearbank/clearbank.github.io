...
When a payment addressed to a virtual account settles, you'll receive a [Transaction Settled webhook](../gbp-payments/faster-payments#transaction-settled-webhook) addressed to that virtual account. You can use this information to help reconcile the balance of a virtual account.
