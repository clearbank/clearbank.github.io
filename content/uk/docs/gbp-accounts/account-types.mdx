...
You can use segregated accounts if you're a Bank, Building Society or a Credit Union who does not issue e-money, to keep your operational funds separate from your customer's funds.
...
* When inspected using [**GET /v3/Accounts/{accountId}**](/uk/docs/gbp-accounts/manage-accounts#get-information-for-an-account-real), returns in the name field: `"Des Seg Wsale account one"`
