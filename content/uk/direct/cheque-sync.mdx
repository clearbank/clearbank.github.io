...
![alt text](/assets/images/diagrams/uk/cheque_endpoint_old.png "Message flow diagram explaining how to submit cheques via the synchronous endpoint. This is explained in the text below.")
