...
![alt text](/assets/images/diagrams/uk/cheques/cheque_endpoint_old.svg "Message flow diagram explaining how to submit cheques via the synchronous endpoint. This is explained in the text below.")
  ...
  endpoints={[
    {
      ...
      version: "1.0Cheques",
      exGateway: true,
      scopeRefs: ["payments:cheques:create"],
       webhooks: [
