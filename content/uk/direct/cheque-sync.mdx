...
The message flow for cheques submitted using the endpoint is shown here.

![alt text](/assets/images/diagrams/uk/cheques/cheque_endpoint_old.svg "Message flow diagram explaining how to submit cheques using the synchronous endpoint.")
