...
Statements can be generated either for all your accounts, or for a specified real account. The statement will be provided via a webhook (see [Use webhooks](../api/getting-started/#use-webhooks)).
