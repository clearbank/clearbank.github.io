...
- The [T2 Financial Institution Inbound Transfer Completed webhook](#t-2-fi-inbound-transfer-completed-webhook) is for incoming payments from financial institutions
...
![T2 message flow diagram](/assets/images/t2-send-payment.svg)
...
<EndpointBlock
  type="post"
  title="Simulate a T2 bank-to-bank payment"
  endpoints={[
    {
