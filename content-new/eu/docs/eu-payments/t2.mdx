...
Customer payments are payments that have either your or another FI's customer as the ultimate debtor or creditor. Institution payments are exclusively FI to FI. Return payments can be returned to either your customer or an FI.
