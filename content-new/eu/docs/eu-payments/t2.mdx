...
| **[/payments/t2-rtgs/v1/institution-payments](#send-a-t-2-payment-to-an-institution)** | Send a T2 payment to an institution (pacs.009) | [T2 FI Outbound Credit Transfer Completed webhook](#t-2-fi-outbound-credit-transfer-completed-webhook)| [T2 FI Outbound Credit Transfer Failed webhook](#t-2-fi-outbound-credit-transfer-failed-webhook)|
...
- The [T2 FI Inbound Transfer Completed webhook](#t-2-fi-inbound-transfer-completed-webhook) is for incoming payments from financial institutions
