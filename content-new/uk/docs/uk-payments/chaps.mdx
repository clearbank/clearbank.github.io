...
The latest versions of the CHAPS endpoints support the new ISO20022 payment message formats. Refer to [FIN to ISO20022 field mapping](#fin-to-iso-20022-field-mapping) for guidance on how the previous MT numbered field values map to the new ISO20022 XML tags.
