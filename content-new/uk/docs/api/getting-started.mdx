...
If your response is invalid, then the webhook is considered to have failed. ClearBank will send the webhook every 15 minutes for 24 hours unless a successful, valid response is returned by you.

**To verify the integrity of the webhook received from ClearBank**
- Download a Public Key specific to your institution by clicking the **Download Public Key** button on the Webhook Management page of the Institution portal.
