...
![alt text](/assets/images/cheque_post.svg "Message flow diagram explaining how to submit cheques via post. In the 'Cheque Paid' outcome, once ClearBank receives the cheque in the post, if it passes processing you will receive the Cheque Paid and Transaction Settled webhooks. In the 'Cheque Not Paid' outcome, once ClearBank receives the cheque in the post, if it fails processing you will receive the Cheque Not Paid webhook.")
