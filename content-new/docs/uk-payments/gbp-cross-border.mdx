...
- If you use version 2, you do not need to provide the details of the intermediary agent. Instead, we'll use the details of the beneficiary to identify the correct intermediary agent on your behalf. We recommend using version 2 due to this benefit.
