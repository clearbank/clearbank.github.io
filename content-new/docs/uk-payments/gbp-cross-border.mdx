...
> If the outbound payment approval occurs outside the availability period, we’ll treat the instruction as having been received during the next GBP availability period when the approval has been received.
