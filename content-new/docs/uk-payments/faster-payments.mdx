...
To protect payment recipients from harm and abuse, outbound payments are subject to screening against a profanity list maintained by Faster Payments scheme. The profanity list can be found on the Reference Documents page of the Knowledge Centre which can be accessed through the ClearBank Portal. Inbound payments are subject to screening by the remitting bank.
