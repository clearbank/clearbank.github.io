...
If you would like to create a customer current account, refer to [Create an account](./retail-customers#create-an-account).

**To create a savings account:**
1. If not already present, create a retail customer using the [Create a retail customer](./retail-customers#create-a-retail-customer) endpoint.
...
**To close the account if the nominated account was not correct:**
