...
At ClearBank, we use Javascript formatted regex/patterns in our endpoint fields. If you're using a language other than Javascript, some characters in the regex we provide may need to be escaped.

It is your responsibility to find details of the regex characters in your programming language. We cannot provide regex in other languages.
