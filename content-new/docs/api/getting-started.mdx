...
No matter how many times we send a webhook, you must respond to it every time, and you must respond the same way every time. You should not send different responses as we will send different retries.
