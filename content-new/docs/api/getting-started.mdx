...
We will retry webhooks that we are able to consider successful every 15 minutes for 24 hours or until you return a successful response. We prefer to be cautious to ensure the webhook has been correctly received.
...
No matter how many times we send a webhook, you **must** respond to it, and respond the same way every time. You should not send different responses as you'll get retries.
