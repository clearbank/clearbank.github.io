...
| [Accounts.VirtualAccountCreated](../multi-currency/manage-multi-currency-accounts#multi-currency-virtual-account-created-webhook) | 1 | Confirmation that a multicurrency virtual account has been created |
...
| [BacsDirectCreditRecalledV1](../uk-payments/bacs#bacs-direct-credit-recalled-webhook) | 1 | Confirmation that a Bacs Direct Credit has been recalled |
| [BacsDirectCreditReturnCreatedV4](../uk-payments/bacs#bacs-direct-credit-return-created-webhook) | 4 | Confirmation that a Bacs Direct Credit return has been created |
