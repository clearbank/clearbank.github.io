...
Once the statement has been generated, you will receive a **Statements Ready For Download** webhook containing a unique **MessageId** and a **TotalPages** value. The statement is divided into pages and each page is assigned a **PageNumber** value. If a page reaches the maximum number of transaction records (10,000), the statement is continued on a new page. Each page is a complete XML file starting with a group header. 
