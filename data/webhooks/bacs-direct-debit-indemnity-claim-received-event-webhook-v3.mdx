...
This webhook notifies you that an [Indemnity Claim](/uk/docs/api/glossary#direct-debit-indemnity-claim) will be settled on the next working day after the processing date specified.
