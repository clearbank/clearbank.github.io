const technicalReferenceTerms = [
...

  {
    ...
    regions: ['uk', 'eu'],
    definition:
      'An EndToEndTransactionId is a payment reference field whose value depends on the payment scheme and transaction direction. Represents the same general concept as EndToEndId.',
    externalLinks: [],
    seoTitle:
  ...
  {
    id: 'end-to-end-identification',
    term: 'End-to-End Identification',
    acronym: 'EndToEndIdentification',
    aliases: [
    ...
    regions: ['uk', 'eu'],
    definition:
      'EndToEndIdentification is a field name used for a payment reference supplied by the initiating party. Represents the same general concept as EndToEndId.',
    externalLinks: [],
    seoTitle:
      'What is EndToEndIdentification?',
    seoDescription:
      'Learn what EndToEndIdentification is and where it is used.',
    relatedTerms: [
      'end-to-end-id',
    ],
    relatedGuides: [
...

  {
    ...
    regions: ['uk', 'eu'],
    definition:
      'An X-Correlation-Id is a ClearBank-generated unique identifier returned in an API response. It should be referenced when raising an issue about an API call.',
    externalLinks: [],
    seoTitle:
...

  {
    ...
    regions: ['uk'],
    definition:
      'A Faster Payments Identifier (FPID) is a unique payment identifier generated by the Faster Payments scheme.',
    externalLinks: [],
    seoTitle:
      'What is an FPID?',
    seoDescription:
...

  {
    ...
    regions: ['uk', 'eu'],
    definition:
      'A Unique End-to-End Transaction Reference (UETR) is an end-to-end payment reference used for applicable payment transactions, including payments carried over SWIFT.', 
    externalLinks: [
      {
 ...
 /*{
  ...
  {
  id: 'scheme-end-to-end-id',
  term: 'SchemeEndToEndId',
  acronym: '',
  aliases: [
    'scheme end-to-end id',
    'scheme end to end id',
  ],
  category: 'scheme',
  regions: ['eu'],
  definition:
  'A SchemeEndToEndId is a scheme-specific payment reference used for applicable multi-currency payments.',
  externalLinks: [],
  seoTitle:
    'What is a SchemeEndToEndId?',
  seoDescription:
    'Learn what SchemeEndToEndId means and how it is used to identify applicable scheme payments.',
  relatedTerms: [
    'end-to-end-identification',
    'unique-end-to-end-transaction-reference',
    'actual-end-to-end-transaction-id',
  ...
  relatedGuides: [
    {
      title: 'IDs and Identifiers',
      url: '/eu/docs/api/ids-identifiers',
    },
  ],
  editorialReview: true,
},

{
  ...
  acronym: '',
  aliases: ['digitalsignature', 'digital signature header'],
  category: 'security',
  regions: ['uk', 'eu'],
  definition:
    'A DigitalSignature is a signed hash sent in the header of a request or response, and in every webhook, so ClearBank and clients can each verify the sender.',
  externalLinks: [],
  seoTitle: 'What is a DigitalSignature?',
  seoDescription: 'Learn what the DigitalSignature header is and how it is used to verify requests, responses, and webhooks.',
  relatedTerms: ['nonce', 'x-request-id', 'webhook'],
  relatedGuides: [
...

{
  ...
  term: 'Idempotency',
  acronym: '',
  aliases: ['idempotent', 'idempotent request'],
  category: 'api',
  regions: ['uk', 'eu'],
  definition:
    'Idempotency means a request or webhook can be safely repeated without causing a duplicate action. Clients must handle repeated webhooks idempotently, since ClearBank delivers webhooks at least once.',
  externalLinks: [],
  seoTitle: 'What is idempotency?',
  seoDescription: 'Learn what idempotency means and why webhook handlers must be idempotent.',
  relatedTerms: ['webhook', 'nonce'],
  relatedGuides: [
    { title: 'IDs and Identifiers', url: '/reference/ids-and-identifiers' },
  ],
...

{
  ...
  term: 'Rate Limit',
  acronym: '',
  aliases: ['rate limiting', '429'],
  category: 'api',
  regions: ['uk', 'eu'],
  definition:
    'A rate limit is the number of requests ClearBank allows within a given time, used to protect our systems. Exceeding it returns a 429 status code; clients should wait before retrying the request.',
  externalLinks: [],
  seoTitle: 'What is a rate limit?',
  seoDescription: 'Learn what rate limits are, why ClearBank applies them, and how to handle a 429 response.',
  relatedTerms: ['api'],
  relatedGuides: [
    { title: 'IDs and Identifiers', url: '/reference/ids-and-identifiers' },
  ],
...

{
  ...
  regions: ['uk'],
  definition:
    'A sort code is a six-digit number that identifies a UK bank or branch. ClearBank assigns a sort code to clients during onboarding, and it is used with an account number to route domestic payments.',
  externalLinks: [],
  seoTitle: 'What is a sort code?',
  seoDescription: 'Learn what a sort code is and how it is used to identify UK bank accounts.',
  relatedTerms: ['account-id', 'business-identifier-code'],
  relatedGuides: [
    { title: 'IDs and Identifiers', url: '/reference/ids-and-identifiers' },
  ],
  editorialReview: true,
