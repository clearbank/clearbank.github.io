...
For example, a customer has three ISAs held with ClearBank: **ISA1**, **ISA2**, and **ISA3**.  
If the customer deposits £2,000 into **ISA1**, the financial institutions managing **ISA2** and **ISA3** will receive this webhook.  
The webhooks for **ISA2** and **ISA3** will show a **RemainingSubscriptionAllowance** that has been reduced by £2,000, which reflects deposits and withdrawals of each ISA.

![A customer deposits £2,000 into ISA1, and holds ISA2 and ISA3. The financial institutions responsible for ISA2 and ISA3 will received this webhook](/assets/images/cash-isa-subscription-updated.svg)

<Callout colour="blue">
  This webhook does not account for customer activity on cash ISAs not held with ClearBank.
</Callout>
