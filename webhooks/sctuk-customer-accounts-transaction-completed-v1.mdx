...
This webhook confirms an inbound or outbound SCT UK transaction has completed for an account. A transaction represents a ledger update for an account, and includes the minimum data necessary to support balance reconciliation. You will also receive this webhook when interest is paid into an account.
