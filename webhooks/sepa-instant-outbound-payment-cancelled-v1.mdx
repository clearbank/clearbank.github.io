...
| `PaymentId`                   | **Required**<br />Unique identifier for the payment, assigned by ClearBank. This will match the paymentId returned in the 202 response when you initiated the payment.<br/>Type: `string` <br/>Format: `uuid`                                                                                                  |
| `TimestampCreated`            | **Required**<br />Date and time the transaction was created, in UTC.<br /> Type: `string`<br/>Format: `date-time`                                                                                                                                                                                             |
| `TimestampSubmitted`          | **Required**<br />Date and time the transaction was sent to scheme, in UTC.<br /> Type: `string`<br/>Format: `date-time`                                                                                                                                                                                      |
| `CancellationCode`            | **Required**<br />The cancellation code for the reason the outbound payment was cancelled. <br/>Type: `string`<br/>Pattern: `[^\n]`                                                                                                                                               |
| `CancellationReason`          | **Required**<br />Reason the outbound payment was cancelled.<br/>Type: `string`<br/>Pattern: `[^\n]`                                                                                                                                                                                                          |
...
```json
{
  ...
  "Payload": {
    ...
    "CancellationReason": "Closed Account Number",
