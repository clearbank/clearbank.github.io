---
title: "SEPA Instant CT Outbound Payment Cancelled webhook"
version: 1
webhook: true
---

This webhook confirms a SEPA Instant CT outbound payment has been cancelled.
...
| `CancellationCode` |**Required**<br />The cancellation code for the Payment. Possible values include: AC01, CB01, CNOR, AM04.<br/>Type: `string`|
