...
| `CancellationCode`            | **Required**<br />The cancellation code for the Payment. Possible values include, but are not limited to: AB05, AB08, AB09, AB10, AC01, AC04, AC06, AG01, AG10, AG11, AM02, AM04, AM05, BE04, CB01, CNOR, DNOR, MD07, MS02, RC01, RR03, RR04, TM01.<br/>Type: `string`<br/>Pattern: `[^\n]`                                                                                                                                               |
