...
| `CancellationCode`            | **Required**<br />The cancellation code for the Payment. Possible values include: AC01, AM02, AM03, AM04, CB01, and CNOR.<br/>Type: `string`<br/>Pattern: `[^\n]`                                                                                                                                               |
