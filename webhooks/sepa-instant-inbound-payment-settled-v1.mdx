...
| `SchemePaymentMethod`         | **Required**<br />Payment scheme used to submit the transaction. This will always be INST, which indicates SEPA CT Inst.<br /> Type: `string`                                                                                                                                                          |
...
| `TransactionReference`   | **Optional**<br />Provides contextual information about the payment. For outbound SCT Inst transactions, this will match the information supplied in the Reference field. For inbound SCT Inst transactions, this provides unstructured remittance information; structured information if unstructured is not provided; otherwise NOTPROVIDED.<br/>Type: `string`<br/>Max. Length: `143`<br/>Min. Length: `1` |
...
```json
{
  ...
  "Payload": {
    ...
    "TransactionReference": "InvoiceReference00189900567844320"
  },
  "Nonce": 1225137631
}
```
