...
#### Example Customer Accounts Transaction Completed for inbound T2 payment
...
```
#### Example Customer Accounts Transaction Completed for outbound T2 payment
...
#### Example Customer Accounts Transaction Completed for inbound SCT payment
...
#### Example Customer Accounts Transaction Completed for outbound SCT payment
...
#### Example Customer Accounts Transaction Completed for inbound SCT Inst payment
...
#### Example Customer Accounts Transaction Completed for outbound SCT Inst payment
