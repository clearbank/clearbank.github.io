---
title: "SEPA Instant CT Recall Payment Settled webhook"
version: 2
webhook: true
---

This webhook confirms an outbound or inbound SEPA Instant CT payment related to a recall request has settled.
