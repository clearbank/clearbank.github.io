...
**This webhook confirms that an FX trade has been cancelled. If a same-day trade fails (for example, due to  insufficient funds), you are immediately notified of the failure, after which you recieve this webhook informing you that ClearBank has cancelled the trade.**
