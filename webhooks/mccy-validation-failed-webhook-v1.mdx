...
```json
{
    "Type":"MccyPayloadValidationFailed",
    "Version": 1,
    "Payload": {...},
    "Nonce":
}
...
| `UltimateDebtorName`    | *Optional*<br /> Name of the ultimate debtor making the payment.<br /> Type: `string`<br /> Min. Length: `0`<br /> Max. Length: `140`<br />                                                                               |
...
| `Reference`             | **Required**<br /> Reference provided by the ultimate debtor for the payment.<br /> Type: `string`<br /> Min. Length: `1`<br /> Max. Length: `140`<br />                                                                  |
...
| `UltimateCreditorName`  | **Required**<br /> Name of the ultimate creditor.<br /> Type: `string`<br /> Min. Length: `1`<br /> Max. Length: `140`<br />                                                                                              |
