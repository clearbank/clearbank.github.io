...
| `CHAPSISO20022Message`                       | *(Optional)*<br />Only if `Scheme` is Chaps; ISO 20022 (MX) compliant version of the transaction message. *Note*: This value can be very long.<br />Type: `string`<br /> Min. Length: `0`<br /> Max. Length: `80000` <br /> Example: See below.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
