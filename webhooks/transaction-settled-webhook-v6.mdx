...
| `Iso20022XmlDocument`                       | *(Optional)*<br />Only appears if `Scheme` is Chaps and the message type received is in ISO 20022 (MX) format. Content of the Document node (payload) of the received payment message, to enable processing of ISO 20022 messages for CHAPS. This value can be very long. See below for examples. <br />Type: `string`<br /> Min. Length: `0`<br /> Max. Length: `80000` <br />                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
