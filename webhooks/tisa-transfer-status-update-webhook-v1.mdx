...
| `MessageId` | string | - | Yes | 1-35 | `^[A-Z0-9\-]{35}$` | The unique message reference from the Swift message. |
| `TimestampCreated` | string | date-time | Yes | - | - | Timestamp created. |
| `ReceiverSun` | string | - | Yes | 1-6 | `^[0-9]{6}$` | The SUN (Service User Number) of the party receiving the status. |
| `InitiatorSun` | string | - | Yes | 1-6 | `^[0-9]{6}$` | The SUN (Service User Number) of the party issuing the status. |
