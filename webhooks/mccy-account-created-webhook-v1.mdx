...
| `Kind`                  | **Required**<br /> The type of funds the account will hold.<br /> Type: `string`<br /> Examples: `YourFunds`, `GeneralSegregated`, `DesignatedSegregated`, `GeneralClient`, `DesignatedClient`, `GeneralSafeguarded`, `DesignatedSafeguarded`<br />                      |
