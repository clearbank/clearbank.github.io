...
| `RejectionCode`         | **Required**<br />Specifies the reason for the rejection of the recall. Reject codes include, but are not limited to: AC04, AM04, ARDT, ARJT, CUST, LEGL, NOAS, NOOR, RNPR, RR04. External code sets can be downloaded from [iso20022.org](https://www.iso20022.org). <br/>Type: `string` |
